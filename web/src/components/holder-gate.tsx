...
export function HolderGate({ children }: { children: React.ReactNode }) {
  ...
  if (!ready) {
    return <div className="imd-stack p-8 text-center font-mono text-sm">initializing…</div>;
  }

  if (authenticated && isLoading) {
    return (
      <div className="imd-stack p-8 text-center font-mono text-sm">
  ...
  if (!authenticated) {
    return (
      <div className="imd-stack p-8 text-center">
